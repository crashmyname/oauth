<section class="section">
    ...
    <div class="section-body">
        ...
        echo '$yourmodel = YourModel::orWhere("kondisi","=","$kondisi");<br>';
        echo '$yourmodel = YourModel::whereIn("kondisi",["array"]");<br>';
        echo '$yourmodel = YourModel::whereDate();<br>';
        echo '$yourmodel = YourModel::whereMonth();<br>';
        echo '$yourmodel = YourModel::whereYear();';
        echo '$yourmodel = YourModel::whereBetween("kondisi","$kondisipertama","$kondisikedia");';
        echo '</code>';
        echo '</pre>';
        ?>
        Penggunaan distinct:
